...
#if (TFM_PLATFORM_VARIANT == APOLLO_FVP_VARIANT_FVP)
#define PS_NUM_ASSETS                          30
#elif (TFM_PLATFORM_VARIANT == APOLLO_FVP_VARIANT_RTL)
...
/*
 * Apollo RTL FPGA uses a lower peripheral clock than other Apollo variants.
